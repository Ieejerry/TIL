...
컬렉션 클래스의 특징과 관계를 그림으로 정리해보았다. 각 컬렉션 클래스마다 장단점이 있으므로 구현원리와 특징을 잘 이해해서 상황에 가장 적합한 것을 선택하여 사용하면 된다.

![image](https://ifh.cc/g/C9JAVL.png)

</br>

![image](https://ifh.cc/g/gq7rjo.png)